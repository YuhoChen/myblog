  ...
  <div id="edit-article">
    <div class="header-wrap">
      ...
      <div class="action-btn-wrap">
        ...
        <span @click="upload" v-if="canUpload">上传</span>
        <input type="file" name="avatar" accept="*text/markdown" @change="change($event)" style="display:none" ref="avatarInput"/>
      </div>
    </div>
    <div class="edit-wrap">
  ...
  methods: {
    ...
    startUploadImg(formParams, pos) {
      this.uploadToQiniu(formParams)
        .then((qiniuData) => {
          this.$refs.md.$img2Url(pos, qiniuData.url)
        })
        .catch((err) => {
    ...
    change(e){
      ...
      reader.onload = function(e) {
        that.article.content =  reader.result
      }
    },
    modify() {
      let params = this.getParams()
